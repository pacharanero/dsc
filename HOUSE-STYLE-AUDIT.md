...
- [ ] `HSA-P1-02B` Require the CI gate before merge. A `main` protection rule is active, but it currently has no required status checks or review requirement (checked 2026-07-23).
