_dsc() {
    ...
    do
        case "${cmd},${i}" in
            ...
            dsc__backup__help,create)
                cmd="dsc__backup__help__create"
                ;;
            dsc__backup__help,help)
                cmd="dsc__backup__help__help"
                ;;
            dsc__backup__help,list)
                cmd="dsc__backup__help__list"
                ;;
            dsc__backup__help,restore)
                cmd="dsc__backup__help__restore"
                ;;
            dsc__category,copy)
            ...
            dsc__category,push)
                ...
                ;;
            dsc__category__help,copy)
                cmd="dsc__category__help__copy"
                ;;
            dsc__category__help,help)
                cmd="dsc__category__help__help"
                ;;
            dsc__category__help,list)
                cmd="dsc__category__help__list"
                ;;
            dsc__category__help,pull)
                cmd="dsc__category__help__pull"
                ;;
            ...
            dsc__group__help,copy)
                ...
                ;;
            dsc__group__help,help)
                cmd="dsc__group__help__help"
                ;;
            dsc__group__help,info)
                cmd="dsc__group__help__info"
                ;;
            ...
            dsc__help,add)
                ...
                ;;
            dsc__help,backup)
                cmd="dsc__help__backup"
                ;;
            dsc__help,category)
                cmd="dsc__help__category"
                ;;
            ...
            dsc__help,emoji)
                ...
                ;;
            dsc__help,group)
                cmd="dsc__help__group"
                ;;
            dsc__help,help)
                cmd="dsc__help__help"
                ;;
            dsc__help,import)
                cmd="dsc__help__import"
                ;;
            dsc__help,list)
                cmd="dsc__help__list"
                ;;
            dsc__help,open)
                ...
                ;;
            dsc__help,palette)
                cmd="dsc__help__palette"
                ;;
            dsc__help,plugin)
                cmd="dsc__help__plugin"
                ;;
            dsc__help,setting)
                cmd="dsc__help__setting"
                ;;
            dsc__help,theme)
                cmd="dsc__help__theme"
                ;;
            dsc__help,topic)
                cmd="dsc__help__topic"
                ;;
            dsc__help,update)
                cmd="dsc__help__update"
                ;;
            dsc__help,version)
                cmd="dsc__help__version"
                ;;
            dsc__help__backup,create)
                cmd="dsc__help__backup__create"
                ;;
            dsc__help__backup,list)
                cmd="dsc__help__backup__list"
                ;;
            dsc__help__backup,restore)
                cmd="dsc__help__backup__restore"
                ;;
            dsc__help__category,copy)
                cmd="dsc__help__category__copy"
                ;;
            dsc__help__category,list)
                cmd="dsc__help__category__list"
                ;;
            dsc__help__category,pull)
                cmd="dsc__help__category__pull"
                ;;
            ...
            dsc__help__group,copy)
                ...
                ;;
            dsc__help__group,info)
                cmd="dsc__help__group__info"
                ;;
            ...
            dsc__help__list,tidy)
                ...
                ;;
            dsc__help__palette,list)
                cmd="dsc__help__palette__list"
                ;;
            dsc__help__palette,pull)
                cmd="dsc__help__palette__pull"
                ;;
            dsc__help__palette,push)
                cmd="dsc__help__palette__push"
                ;;
            dsc__help__plugin,install)
                cmd="dsc__help__plugin__install"
                ;;
            dsc__help__plugin,list)
                cmd="dsc__help__plugin__list"
                ;;
            ...
            dsc__help__setting,set)
                ...
                ;;
            dsc__help__theme,duplicate)
                cmd="dsc__help__theme__duplicate"
                ;;
            dsc__help__theme,install)
                cmd="dsc__help__theme__install"
                ;;
            dsc__help__theme,list)
                cmd="dsc__help__theme__list"
                ;;
            dsc__help__theme,pull)
                cmd="dsc__help__theme__pull"
                ;;
            dsc__help__theme,push)
                cmd="dsc__help__theme__push"
                ;;
            ...
            dsc__palette,push)
                ...
                ;;
            dsc__palette__help,help)
                cmd="dsc__palette__help__help"
                ;;
            dsc__palette__help,list)
                cmd="dsc__palette__help__list"
                ;;
            dsc__palette__help,pull)
                cmd="dsc__palette__help__pull"
                ;;
            dsc__palette__help,push)
                cmd="dsc__palette__help__push"
                ;;
            dsc__plugin,help)
            ...
            dsc__plugin__help,help)
                cmd="dsc__plugin__help__help"
                ;;
            dsc__plugin__help,install)
                cmd="dsc__plugin__help__install"
                ;;
            dsc__plugin__help,list)
                cmd="dsc__plugin__help__list"
                ;;
            ...
            dsc__theme__help,duplicate)
                cmd="dsc__theme__help__duplicate"
                ;;
            dsc__theme__help,help)
                cmd="dsc__theme__help__help"
                ;;
            dsc__theme__help,install)
                cmd="dsc__theme__help__install"
                ;;
            dsc__theme__help,list)
                cmd="dsc__theme__help__list"
                ;;
            dsc__theme__help,pull)
                cmd="dsc__theme__help__pull"
                ;;
            dsc__theme__help,push)
                cmd="dsc__theme__help__push"
                ;;
            dsc__theme__help,remove)
                cmd="dsc__theme__help__remove"
                ;;
            dsc__topic,help)
    ...
    case "${cmd}" in
        dsc)
            ...
            ;;
        dsc__add)
            opts="-i -h --interactive --help <NAMES>"
        ...
        dsc__category__push)
            ...
            ;;
        dsc__completions)
            opts="-d -h --dir --help bash zsh fish"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        dsc__help__setting__set)
            ...
            ;;
        dsc__help__theme)
            opts="list install remove pull push duplicate"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        dsc__palette__list)
            ...
            ;;
        dsc__palette__pull)
            opts="-h --help <DISCOURSE> <PALETTE_ID> [LOCAL_PATH]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        dsc__palette__push)
            opts="-h --help <DISCOURSE> <LOCAL_PATH> [PALETTE_ID]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        dsc__plugin__help__remove)
            ...
            return 0
            ;;
        dsc__plugin__install)
            opts="-h --help <DISCOURSE> <URL>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        dsc__theme)
            ...
            return 0
            ;;
        dsc__theme__duplicate)
            opts="-h --help <DISCOURSE> <THEME_ID>"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        dsc__theme__help)
            opts="list install remove pull push duplicate help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        dsc__theme__list)
            ...
            ;;
        dsc__theme__pull)
            opts="-h --help <DISCOURSE> <THEME_ID> [LOCAL_PATH]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            ;;
        dsc__theme__push)
            opts="-h --help <DISCOURSE> <LOCAL_PATH> [THEME_ID]"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 3 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _dsc -o nosort -o bashdefault -o default dsc
else
    complete -F _dsc -o bashdefault -o default dsc
fi
