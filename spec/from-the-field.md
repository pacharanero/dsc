...
|---|---|---|---|---|
| [category-workflow.md](commands/category-workflow.md) | MkDocs ↔ Discourse content portability for category topic sync: admonition conversion and URL/link rewriting. | 2026-06-22 | Yes for the surrounding category pull/push workflow; the remaining conversion work is local content transformation, not a new API endpoint. | Gaps 1–3 and 5 implemented; Gap 4 planned. |
